  ...
  return (
    ...
    >
      ...
      <Box w="100%" minH="70vh" h="auto" py={5}>
        <Box w="100%" minH="50vh" h='auto' display="flex" flexDirection="row" justifyContent={{base:'center',md:'center',lg:'space-between'}} flexWrap='wrap' alignItems='flex-start'>
          {categories.map((category, index) => (
            ...
            >
              <Text fontSize="m" color="heading" fontWeight="bold">{category.title}</Text>
              <Text fontSize="s" color="heading" fontWeight="normal">(click to see projects)</Text>
            </MotionBox>
          ))}
        </Box>
      </Box>
